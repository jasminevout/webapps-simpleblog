...
<head>
	...
	<title>Categories | Blog de Omnibus</title>
...
<body>
	...
	<div class="container">
		<p class="col posts-in"><i class="fas fa-list fa-xs"></i> Posts in <?php echo $row['catTitle'];?></p>
		<hr>

		<div class="row">
			<!-- MAIN CONTENT -->
			<div id='main' class="col">
				<!-- list content from blog_posts belonging to this category --> 
				<?php	
				try {
					// pagination
					// instantiate class
					...
					FROM 
						...
						blog_cat_cats
					WHERE
						blog_posts.postID = blog_cat_cats.postID
						AND blog_cat_cats.catID = :catID
					ORDER BY 
						postID DESC
					');
					$stmt->execute(array(':catID' => $row['catID']));
